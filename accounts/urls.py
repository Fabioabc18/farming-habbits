...
urlpatterns = [
    ...
    path("accounts/reset_password_complete/", auth_views.PasswordResetCompleteView.as_view(template_name="registration/password_complete.html"), name="password_reset_complete"),
]
